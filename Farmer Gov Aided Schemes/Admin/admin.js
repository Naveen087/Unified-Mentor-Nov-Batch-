...
function editInfo(
  ...
  // Add bullets to text
  userName.value = name;
  eligibility.value = addBulletsToText(Eligibility);
  exclusions.value = addBulletsToText(Exclusions);
  documents.value = addBulletsToText(Documents);
  benefits.value = addBulletsToText(Benefits);

  submitBtn.innerText = "Update";
  modalTitle.innerText = "Update the Scheme";
}

function deleteInfo(index) {
  if (confirm("Are you sure you want to delete the Scheme?")) {
